...
public class Cache {
	...
	public static InnerKey createKey(
	...
	public static Pair<AnalysisState<?>, AnalysisState<?>> getAnalysisStates(
			InnerKey key,
			AnalysisState<?> state) {
		return key.getResult(state);
	}

	public static boolean containsKeyAndState(
			InnerKey key,
			AnalysisState<?> state) {
	...
	public static final class InnerKey {
		...
		Pair<AnalysisState<?>, AnalysisState<?>> getResult(
				AnalysisState<?> state) {
		...
		<A extends AbstractState<A>> void putResult(
				AnalysisState<A> state,
				Pair<AnalysisState<A>, AnalysisState<A>> analysisStates) {
			this.addState(state);
