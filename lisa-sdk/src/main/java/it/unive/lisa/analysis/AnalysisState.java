...
public class AnalysisState<A extends AbstractState<A>>
	...
	public Pair<AnalysisState<A>, AnalysisState<A>> split(
			SymbolicExpression expression,
			ProgramPoint src,
			ProgramPoint dest)
			throws SemanticException {
		...
		AnalysisState<A> falseCaseState = new AnalysisState<>(states.getRight(),
				new ExpressionSet(negatedComputedExpression), info);
